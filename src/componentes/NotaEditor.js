...
export default function NotaEditor({ mostraNotas, notaSelecionada, setNotaSelecionada }) {
  ...
  // async function salvaNota() {
  //   const id = (await gerarId()).toString()
  //   const nota = {
  //     id,
  //     texto: texto
  //   }
  ...
  //   if(totasChaves.length < 1){
  //     return 1
  //   }

  //   return totasChaves.length + 1
  // }
        ...
        <View style={estilos.centralizaModal}>
          <ScrollView showsVerticalScrollIndicator={false}>
            <View style={estilos.modal}>
              {notaParaAtualizar ? <Text style={estilos.modalTitulo}>Atualizar nota</Text> : <Text style={estilos.modalTitulo}>Criar nota</Text>}
